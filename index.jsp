...
try{
	...
	bolsonaro = vtdao.consultarVotosCandidato(1);
	ciro = vtdao.consultarVotosCandidato(2);
	marina = vtdao.consultarVotosCandidato(3);
	alckmin = vtdao.consultarVotosCandidato(4);
	haddad = vtdao.consultarVotosCandidato(5);
	vtdao.fechar();
...
<html>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#">POLIBOTS</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#">Canarinho</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#">Urna</a>
            </li>
            <li class="nav-item">
          ...
          <div class="d-flex justify-content-center">
              ...
              <form class="form-inline" id="passo01">
                  ...
                  <button type="button" class="btn btn-primary" id="enviar-token" onclick="enviarToken()">Enviar Token</button>
              	  <span id="telefone-invalido" class="d-none text-danger">Telefone Inválido!</span>
              </form>
              ...
              <form class="form-inline d-none" id="passo02">
                  <div class="form-group">
                      ...
                      <span id="token-invalido" class="d-none text-danger">Token Inválido!</span>
                  </div>
              </form>
              ...
              <div class="input-group d-none" id="passo03" style="width: 500px !important">
				  <select class="custom-select" id="idCandidato">
				    ...
				    <option value="2">Ciro Gomes</option>
				    <option value="5">Fernando Haddad</option>
				    <option value="4">Geraldo Alckmin</option>
				    <option value="1">Jair Bolsonaro</option>
				    <option value="3">Marina Silva</option>
				  </select>
				  <div class="input-group-append">
				    <button class="btn btn-success" type="button" id="confirmaVoto">Confirma</button>
				  </div>
				  <span id="confirmacao-voto" class="text-success d-none">Voto cadastrado com sucesso!</span>
			  </div>
