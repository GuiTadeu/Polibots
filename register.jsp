...
<%@page import="br.com.polibots.servlet.TestWatson"%>
...
<div class="d-flex mt-20 justify-content-center" id="center">
  <div class="card border-success  mb-3 " style="width: 20rem;" id="login">
    <div class="card-header bg-transparent border-success">Registro</div>
<div class="card-body text-center">
  ...
  <div class="form-group row">
    <label for="inputPassword3" class="col-sm-4 col-form-label">Senha</label>
    <div class="col-sm-10">
      <input type="password" class="form-control" id="inputPassword3" placeholder="Sua senha">
    </div>
    <div class="form-group row">
    <label for="inputPassword3" class="col-sm-4 col-form-label ml-3">Re-digite</label>
    <div class="col-sm-10">
      <input type="re-password" class="form-control ml-3" id="inputPassword3" placeholder="Re-digite sua senha">
    </div>
  </div>
